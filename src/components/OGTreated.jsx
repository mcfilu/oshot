...
// import { breastlift_treated1, breastlift_treated2, breastlift_treated3, size, erectile_dysfanction, premature1 } from '../assets'
...
//                     <p className={`text-gold1 text-center text-[3.5vh] mb-[1vh]`}>size</p>
//                     <div className={`w-full h-[50%] bg-white rounded-[9px]`}><img src={size} className={`w-full h-full rounded-[9px]`} ></img></div>
...
import React from 'react'
import {erectile, size, orgasm, ejaculation} from '../assets'

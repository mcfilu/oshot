  ...
  return (
    <div className={`flex w-full flex-row md:min-h-[55vh]  md:p-[2vh] md:pl-[0px]`}>
        ...
        <p className={`flex text-[4.5vh] font-header text-gold1 mt-[2vh]`}>Dr. Sherif Wakil</p>
            ...
            <p className={`flex text-white text-[2.5vh] text-center text-gold1 `}>Childbirth, can result in the stretching of the vagina and weakening of the pelvic floor muscles. Additionally, the effects of menopause can lead to various physical and functional changes, such as excessive dryness, thinning of the vaginal wall, pain, and urinary incontinence. Many women are concerned about experiencing leaks before reaching the bathroom or during exercise, difficulties achieving orgasms, less intense orgasms, and decreased lubrication.</p>
            <p className={`flex text-white text-[2.5vh] text-center text-gold1 `}>Thankfully, ThermiVa offers a non-surgical and painless solution to address these intimate concerns. Developed specifically for women, ThermiVa aims to alleviate the effects of childbirth and menopause, providing a revitalizing treatment option to restore feminine well-being and enhance intimate experiences.</p>

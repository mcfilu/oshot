  ...
  return (
    <div className={`flex w-full flex-row md:min-h-[55vh]  md:p-[2vh] md:pl-[0px]`}>
        ...
        <p className={`flex text-[4.5vh] font-header text-gold1 mt-[2vh]`}>Dr. Sherif Wakil</p>
            ...
            <p className={`flex text-white text-[2.5vh] text-center text-gold1 `}>The O-Shot® is a vital element of the transformative therapy known as The O Concept™. This innovative approach encompasses state-of-the-art technology, pioneering treatments, and natural supplements, all dedicated to enhancing sexual well-being and satisfaction.</p>
            <p className={`flex text-white text-[2.5vh] text-center text-gold1 `}>By harnessing the power of Platelet Rich Plasma (PRP), the O-Shot® procedure taps into the body's innate healing and rejuvenating capabilities. Through targeted injections of PRP, abundant in growth factors, the O-Shot® triggers a regenerative process that stimulates the body's natural ability to heal and renew itself, particularly in the intimate areas.</p>
